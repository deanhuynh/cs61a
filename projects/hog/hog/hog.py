            ...
            if(increase > 0):
                if(increase > previous_high):
                    ...
                    if(increase == 1):
                        ...
                        print(str(increase) + " points! That's the biggest gain yet for Player 0")
            else:
                silence(score0, score1)
            ...
            if(increase > 0):
                if(increase > previous_high):
                    ...
                    if(increase == 1):
                        ...
                        print(str(increase) + " points! That's the biggest gain yet for Player 1")
            else:
                silence(score0, score1)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    max_average = 0
    while(roll_num <= 10):
        curr_average = make_averaged(roll_dice)(roll_num, dice)
