...
class Fib():
    ...
    def next(self):
        ...
        Fib.previous, a = self.value, self.value + Fib.previous
        return Fib(a)
...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.balance == self.price:
            ...
            self.balance = 0
            self.stock -= 1
            return 'Here is your {0} and ${1} change.'.format(self.snack, prebalance - self.price)
        else:
    ...
    def ask(self, message, *args):
        ...
        if not message.startswith(magic_word):
            ...
            if args:
                ...
                return getattr(self.obj, message[7:])()
        else:
